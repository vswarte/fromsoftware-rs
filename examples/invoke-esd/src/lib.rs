    ...
    pub fn step(&mut self) -> Result<(), EzStateInvokeError> {
        self.state = match self.state {
            ...
            TalkScriptDemoState::EnterMainMenu => {
                // ClearTalkListData()
                self.talk_script
                    .event([EzStateValue::Int32(CLEAR_TALK_LIST_DATA)])?;

                // AddTalkListData(1, 20000010, -1) // "Purchase"
                self.talk_script.event([
            ...
            TalkScriptDemoState::WhileMainMenu => {
                ...
                let specific_person_menu_is_open: i32 = self
                    .talk_script
                    .env([
                ...
                let specific_person_generic_dialog_is_open: i32 = self
                    .talk_script
                    .env([
