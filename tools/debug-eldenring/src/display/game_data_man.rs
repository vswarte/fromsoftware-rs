...
impl DebugDisplay for TrophyWeaponStats {
    fn render_debug(&self, ui: &Ui) {
        ...
        ui.display("Marais Executioner's Sword", self.marais_executioners_sword);
...
impl DebugDisplay for TrophyGoodsStats {
    fn render_debug(&self, ui: &Ui) {
...
impl DebugDisplay for TrophyAccessoryStats {
    fn render_debug(&self, ui: &Ui) {
