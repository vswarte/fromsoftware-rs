...
#[vtable_rs::vtable]
pub(crate) trait CSEzStateTalkEventVmt {
...
pub struct CSEzStateTalkEvent {
    pub(crate) vftable: VPtr<dyn CSEzStateTalkEventVmt, Self>,
    unk8: usize,
...
#[vtable_rs::vtable]
pub(crate) trait CSEzStateTalkEnvVmt {
    fn destructor(&mut self);
...
pub struct CSEzStateTalkEnv {
    pub(crate) vftable: VPtr<dyn CSEzStateTalkEnvVmt, Self>,
    unk8: usize,
    pub talk_id: i32,
    pub npc_talk_ins: NonNull<CSNpcTalkIns>,
    unk20: bool,
