...
impl TalkScript {
    ...
    /// Execute a single ESD event with the given arguments, or return an error if the singletons
    /// accessed by the ESD system aren't initialized.
    ///
    /// # Safety
    ///
    ...
    /// singletons accessed by the ESD system aren't initialized.
    ///
    /// # Safety
    ///
