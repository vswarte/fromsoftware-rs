//! This module contains higher-level utilities for working with Sekiro. They're
//! built on top of the definitions in the rest of the crate, and they're
//! intended to simplify common mod tasks and provide a safer, more Rust-like
//! interface.
//!
//! ## Compatibility
//!
